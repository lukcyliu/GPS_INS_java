...
//---------------------------------------------滑动滤波-----------------------------------------------------------------//
            ...
            //暴力方法
            smoothRes = smoothTest.slideWindows(acc.get(0,0), acc.get(1,0), acc.get(2,0), gx, gy, gz, mx, my, mz, GPSYaw, GPSv);
...
//           //右前上
//            updateRMatrix(mahonyR,(float)smoothAx,(float)smoothAy,(float)smoothAz,(float)smoothGx,(float)smoothGy,(float)smoothGz,(float)smoothMx,(float)smoothMy,(float)smoothMz);
...
//                    "," + hAx + "," + hAy + "," + hVx + "," + hVy + "," + hSx + "," + hSy + "," + hSx2 + "," + hSy2 + "," + hV2 + "," + hS2 + "\n");
            ...
            csvHelper.write(ax + "," + ay + "," + az + "," + acc.get(0,0) + "," +
                    acc.get(1,0) + "," + (acc.get(2,0) - 0.98015) + "," +smoothAx + "," + smoothAy + "," + (smoothAz - 0.98015)  +","+ acc_mod + "," +
                    acc_mod_end + "," + acc_mod_err +","+GPSVe+","+GPSVn+  "\n");
